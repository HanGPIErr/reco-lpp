...
namespace RecoTool.Infrastructure.Repositories
{
    ...
    public sealed class ReconciliationRepository : IReconciliationRepository
    {
        ...
        public Task<List<ReconciliationViewData>> GetReconciliationViewAsync(string countryId, string filterSql = null)
            => _service.GetReconciliationViewAsync(countryId, filterSql);
